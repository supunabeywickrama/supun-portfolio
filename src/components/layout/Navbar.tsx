      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://drive.google.com/uc?export=download&id=1up-6o6HO0bf4qZgIAMCDm9EjjjQI2DEh" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm font-mono text-cyan-400 border border-cyan-400/30 rounded hover:bg-cyan-400/10 transition-colors">
              Resume
            </a>
          </div>
