      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://drive.google.com/uc?export=download&id=1CZISuAzSv5iJqgNqamwzNCdqVataVxgE" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-sm font-mono text-cyan-400 border border-cyan-400/30 rounded hover:bg-cyan-400/10 transition-colors">
              Resume
            </a>
          </div>
      ...
      <AnimatePresence>
        ...
        height: 0
            ...
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <a href="https://drive.google.com/uc?export=download&id=1CZISuAzSv5iJqgNqamwzNCdqVataVxgE" target="_blank" rel="noopener noreferrer" className="block mt-4 mx-3 px-4 py-3 text-center text-base font-mono text-navy-900 bg-cyan-400 rounded-md hover:bg-cyan-500">
                Download Resume
              </a>
            </div>
          </motion.div>}
